...
class Robot:
    ...
    def close_chopsticks(self, robot):
        helper.control_joints(robot, CHOPSTICK_JOINT_NUMBERS, (-3, -3), velocity_scale=1, max_force=5)
    ...
    def go_to_object(self, robot, obj, offset = 0.0):
        ...
        obj_tf_matrix[2, 2] += offset
        ee_tf_matrix = pb_utils.pose_from_tform(obj_tf_matrix @ chopstick_tf_matrix)
